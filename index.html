...
<body>
  <div style="position: fixed; top: 75px; left: -225px; width: 600px; padding: 10px; font-size: 24px; text-align: center; color: white; font-family: 'trebuchet ms', verdana, arial, sans-serif;transform: rotate(-45deg);transform-origin: 50% 0px;-o-transform: rotate(-45deg); -o-transform-origin: 50% 0px;-moz-transform: rotate(-45deg); -moz-transform-origin: 50% 0px; -webkit-transform: rotate(-45deg); -webkit-transform-origin: 50% 0px; background-color: Transparent; border: 1px solid rgb(170, 170, 170); z-index: 9999; opacity: 0.5;"><a href="https://www.facebook.com" style="text-decoration:none;color:white;">TEAM-TRANSFORMERS</a></div>
<div class="stars">
  <center>
    <h1>HACKED BY Mr RootCode</h1>
  </center>
</div>
<div class="twinkling">
  <center><br><br><br>
    <img src="https://raw.githubusercontent.com/mrrootcode/index.php/master/hackedbymohinuddin.png" width="250"/><br>
    <div class="container">
      <div class="text"></div>
    </div><br><br><br>
    <font face="Sarpanch" color="white" size"10" class="message">
      |&nbsp;  A house without security, cannot be home <font color="red">security </font>i really love you buddy&nbsp;  |
    </font><br>
    <font face="Sarpanch" color="white" size"10" class="message">#JUST &bull; remember me in your prayers <font color="red">hacked by bumblebee from team-tranformers.</font><br><br>
    <font face="Play">
      <p class="we-are"><b>WE <font color="cyan">ARE<font color="white">:</b></p>
    </font>
    <font face="Play" class="cn">
      -= Bumblebee <font color="cyan">|</font> Optimus-prime <font color="cyan">|</font> Megaton <font color="cyan">|</font> Soundwave <font color="cyan">|</font> lambo <font color="cyan">|</font> jetfire <font color="cyan">|</font> Rodimus-prime <font color="cyan">|</font> Ratchet<font color="cyan">|</font> Grive
  </center>
</div>
<div class="clouds">
</div>
<iframe width="1" height="1" src="https://www.youtube.com/embed/Jl_UAmmWH1o?rel=0&autoplay=1" frameborder="0" allowfullscreen></iframe>
...
<script type="text/javascript">
    ...
    const phrases = [
      ...
      'i am here to protect you as a your friend.',
      'if you did not want to accept me as friend.',
	  'i can be a your enemy also.',
      'JUST SAY CHEESE....'
    ...
    var app = {
      ...
      chars: ['Mr RootCode', 'hacked', 'aws29', 'hello', 'optimus-prime', 'Megatron', 'Rodimus-prime', 'Ratchet', 'Quintesa', 'love you', 'Mr RootCode', '', 'Mr RootCode', 'Mr RootCode','Mr RootCode','Mr RootCode','Mr RootCode','Mr RootCode','Mr RootCode'],
